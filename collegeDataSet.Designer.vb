...
Namespace collegeDataSetTableAdapters
    ...
    Partial Public Class studentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `student` (`roll_no`, `Name`, `Gender`, `Age`, `Address`) VALUES (@p1"& _ 
                ", @p2, @p3, @p4, @p5)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `student` SET `roll_no` = @p1, `Name` = @p2, `Gender` = @p3, `Age` = @p4, "& _ 
                "`Address` = @p5 WHERE ((`roll_no` = @p6) AND (`Name` = @p7) AND (`Gender` = @p8)"& _ 
                " AND (`Age` = @p9) AND (`Address` = @p10))"
        ...
        Public Overloads Overridable Function Insert(ByVal p1 As UInteger, ByVal p2 As String, ByVal p3 As String, ByVal p4 As UInteger, ByVal p5 As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal p1 As UInteger, ByVal p2 As String, ByVal p3 As String, ByVal p4 As UInteger, ByVal p5 As String, ByVal p6 As UInteger, ByVal p7 As String, ByVal p8 As String, ByVal p9 As UInteger, ByVal p10 As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal p2 As String, ByVal p3 As String, ByVal p4 As UInteger, ByVal p5 As String, ByVal p6 As UInteger, ByVal p7 As String, ByVal p8 As String, ByVal p9 As UInteger, ByVal p10 As String) As Integer
